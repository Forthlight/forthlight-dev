...
do
	...
	Update-Everything ) echo -e "${g}Doing all the things!";echo -e "${g}Updating Forthlight Development enviroment${c}";git pull origin master;echo -e "${g}Updating a Forthlight submodules and core${c}";git submodule foreach git pull origin dev;echo -e "${g}Update Complete${NC}"; break;;
	Exit ) exit;;
    esac
done
